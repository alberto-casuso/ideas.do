                        ...
                        <div class="qodef-columns-inner">
                            <div class="qodef-column-content qodef-column-content1">
                                <div class="qodef-search-page-holder">
                                    <form action="<?php echo esc_url( home_url( '/' ) ); ?>" class="qodef-search-page-form" method="get">
                                        <div class="qodef-form-holder">
                                            <div class="qodef-column-left">
                                                <input type="text" name="s" class="qodef-search-field" autocomplete="off" value="" placeholder="<?php esc_attr_e( 'Type here', 'coney' ); ?>"/>
                                            </div>
                                        ...
                                        <div class="qodef-search-label">
											<?php esc_html_e( "If you are not happy with the results below please do another search", "coney" ); ?>
                                        </div>
                                    </form>
									...
									<?php endwhile; ?>
									<?php else: ?>
                                        <p class="qodef-blog-no-posts"><?php esc_html_e( 'No posts were found.', 'coney' ); ?></p>
									<?php endif; ?>
									<?php
