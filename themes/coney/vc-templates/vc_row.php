...
$row_content_width = $anchor = $content_text_aligment = $qodef_row_wrapper_start = $qodef_row_wrapper_end = '';
...
if ( ! empty( $content_text_aligment ) ) {
	$css_classes[] = 'qodef-content-aligment-' . $content_text_aligment;
}
...
if ( $row_content_width === 'grid' ) {
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section">';
	$qodef_row_wrapper_end   .= '</div>';
}
...
print coney_qodef_get_module_part( $output );
