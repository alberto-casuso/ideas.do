						...
						ed.windowManager.open( {
							...
							body: [
								...
								},
								{
									...
									onclick: function upload_image_tinymce(e) {
										e.preventDefault();
										var $input_field = jQuery('.mce-my_input_image');
								...
								},
								{
									type: 'textbox',
									name: 'image_size',
									label: 'Image Size (thumbnail, medium, large, full )'
								},
								{
									type: 'listbox',
								...
								},
								{
									type: 'textbox',
									name: 'link',
									label: 'Link(only work if lightbox is set to NO)'
								}
							],
							onsubmit: function( e ) {
								ed.insertContent( '[qodef_single_image image="' + e.data.image + '"  image_size="' + e.data.image_size + '" link="' + e.data.link + '" enable_lightbox="'+ e.data.enable_lightbox +'"]');
							}
						});
					}
				}
