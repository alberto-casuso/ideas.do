<?php if(coney_qodef_options()->getOptionValue('portfolio_single_hide_pagination') !== 'yes') : ?>
    <?php
    $back_to_link = get_post_meta(get_the_ID(), 'portfolio_single_back_to_link', true);
    $nav_same_category = coney_qodef_options()->getOptionValue('portfolio_single_nav_same_category') == 'yes';
    ?>
