...
if ( ! class_exists( 'ConeyQodefSidebar' ) ) {

	class ConeyQodefSidebar {
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'coney' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'coney-qodef-sidebar', QODE_ROOT . '/framework/admin/assets/js/qodef-sidebar.js' );
			wp_enqueue_style( 'coney-qodef-sidebar', QODE_ROOT . '/framework/admin/assets/css/qodef-sidebar.css' );
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__( 'Enter Name of the new Widget Area', 'coney' ) . "' name='qode-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_html__( 'Add Widget Area', 'coney' ) . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'coney_qodef_custom_widget_args', $args );
