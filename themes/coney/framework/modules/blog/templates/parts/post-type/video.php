...
<?php if ( $has_video_link ) { ?>
    <div class="qodef-blog-video-holder">
		...
		if ( $video_type == 'social_networks' ) {
			...
			print coney_qodef_get_module_part( $embed );
            ...
            <div class="qodef-self-hosted-video-holder">
                <div class="qodef-video-wrap">
                    <video class="qodef-self-hosted-video" poster="<?php echo esc_url( get_post_meta( get_the_ID(), "video_format_image", true ) ); ?>" preload="auto">
						<?php if ( ( $meta_temp_mp4 = get_post_meta( get_the_ID(), "qodef_post_video_custom_meta", true ) ) != "" ) { ?>
                        ...
                        <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url( get_template_directory_uri() . '/assets/js/flashmediaelement.swf' ); ?>">
                            ...
                            <img itemprop="image" src="<?php echo esc_url( $meta_temp_image ); ?>" width="1920" height="800" title="<?php esc_attr_e( 'No video playback capabilities', 'coney' ); ?>" alt="<?php esc_attr_e( 'video thumb', 'coney' ); ?>"/>
                        </object>
                    </video>
                </div>
            </div>
