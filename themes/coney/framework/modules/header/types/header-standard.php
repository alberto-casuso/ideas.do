...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = coney_qodef_filter_px(coney_qodef_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('coney_qodef_header_standard_parameters', $parameters);
