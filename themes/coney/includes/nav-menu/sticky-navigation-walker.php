...
if ( ! class_exists( 'ConeyQodefStickyNavigationWalker' ) ) {
	class ConeyQodefStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			//menu type class
			$wide_background = '';
			if ( coney_qodef_get_meta_field_intersect( 'enable_wide_menu_background', coney_qodef_get_page_id() ) == "yes" ) {
