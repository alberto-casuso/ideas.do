...
class HeaderClassic extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $logoAreaHeight       = coney_qodef_filter_px(coney_qodef_options()->getOptionValue('logo_area_height_header_classic'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? coney_qodef_filter_px($logoAreaHeight) : 315;

            $menuAreaHeight       = coney_qodef_filter_px(coney_qodef_options()->getOptionValue('menu_area_height_header_classic'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('coney_qodef_header_classic_parameters', $parameters);
    ...
    public function getPerPageJSVariables($perPageVars) {
        ...
        if(!in_array(coney_qodef_options()->getOptionValue('header_behaviour'), array('sticky-header-on-scroll-up','sticky-header-on-scroll-down-up'))) {
            $perPageVars['qodefHeaderTransparencyHeight'] = $this->headerHeight - (coney_qodef_get_top_bar_height() + $this->heightOfCompleteTransparency);
        }else{
