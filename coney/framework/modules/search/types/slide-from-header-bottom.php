...
if ( ! function_exists('coney_qodef_get_search') ) {
    ...
    add_action( 'coney_qodef_end_of_page_header_html', 'coney_qodef_get_search');
    add_action( 'coney_qodef_end_of_sticky_header_html', 'coney_qodef_get_search');
}
...
if ( ! function_exists('coney_qodef_load_search_template') ) {
    ...
    function coney_qodef_load_search_template() {
        coney_qodef_get_module_template_part('templates/types/slide-from-header-bottom', 'search');
    }
}