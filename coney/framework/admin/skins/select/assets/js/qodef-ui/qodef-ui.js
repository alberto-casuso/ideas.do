(function ($) {
        ...
        wp.media.customlibEditGallery1 = {
            ...
            frame: function () {
                ...
                this._frame.on('update', function () {
                    ...
                    var data = {
                        action: 'coney_qodef_gallery_upload_get_images',
                        ids: ids,
                        post_name: $input_gallery_items.attr('name'),
                        upload_gallery_nonce: $('#coney-qode-update-images_' + $input_gallery_items.attr('name')).val()
                    }
    ...
    function qodefInitAjaxForm() {
        ...
        $(document).delegate(".qodef_ajax_form", "submit", function (a) {
            var b = $(this);
            var c = {
                action: "coney_qodef_save_options"
            };
            jQuery.ajax({
                url: ajaxurl,
                cache: !1,
