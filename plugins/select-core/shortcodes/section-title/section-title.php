<?php
namespace ConeyQodef\Modules\Shortcodes\SectionTitle;
...
class SectionTitle implements ShortcodeInterface	{
	...
	* @return string
	...
	public function render($atts, $content = null) {
		...
		$html = select_core_get_shortcode_template_part('templates/section-title', 'section-title', '', $params);
	...
	private function getTextStyles($params) {
		...
		if (!empty($params['text_font_size'])) {
			$textStyle[] = 'font-size: '.coney_qodef_filter_px($params['text_font_size']).'px';
		}
		
		if (!empty($params['text_margin'])) {
			$textStyle[] = 'margin-top: '.coney_qodef_filter_px($params['text_margin']).'px';
		}
