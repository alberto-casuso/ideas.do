<?php
namespace ConeyQodef\Modules\Shortcodes\CallToAction;
...
class CallToAction implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = select_core_get_shortcode_template_part('templates/call-to-action', 'call-to-action', '', $params);
	...
	private function getHolderClasses($params){
		...
		if(!empty($params['layout'])){
			$holderClasses .= ' qodef-'.$params['layout'].'-layout';
		}
		
		if($params['content_in_grid'] === 'yes' && $params['layout'] === 'normal'){
			$holderClasses .= ' qodef-content-in-grid';
		}
	...
	private function getButtonHolderStyles($params) {
		...
		if (!empty($params['button_top_margin']) && $params['layout'] === 'simple') {
			$styles[] = 'margin-top: '.coney_qodef_filter_px($params['button_top_margin']).'px';
		}
