<?php
namespace ConeyQodef\Modules\Shortcodes\CustomFont;
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => array_flip(coney_qodef_get_font_style_array()),
						"description" => ""
					),
					array(
						"type" => "dropdown",
					...
					array(
						...
						"value" => array_flip(coney_qodef_get_text_transform_array()),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => array(
							esc_html__("None", "coney") => "",
							esc_html__("Underline", "coney") => "underline",
							esc_html__("Overline", "coney") => "overline",
							esc_html__("Line Through", "coney") => "line-through"
						),
						"description" => ""
					),
					array(
					...
					array(
						...
						"value" => array(
							...
							esc_html__("Justify", "coney") => "justify"
						),
						"description" => ""
					),
					array(
						"type" => "textarea",
						"heading" => esc_html__("Content", "coney"),
						"param_name" => "content_custom_font",
						"value" => esc_html__("Custom Font Content", "coney"),
						"description" => "",
						"save_always" => true
					)
				)
