<?php
namespace ConeyQodef\Modules\Shortcodes\IconWithText;

use ConeyQodef\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package ConeyQodef\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
            ...
            'params' => array_merge(
                ...
                array(
                    ...
                    array(
                        ...
                        'dependency' => array('element' => 'icon_type', 'value' => array('qodef-square', 'qodef-circle')),
                        'group'      => esc_html__('Icon Settings', 'select-core')
                    ),
                    array(
                        'type'       => 'colorpicker',
    ...
    public function render($atts, $content = null) {
		...
		return select_core_get_shortcode_template_part('templates/iwt', 'icon-with-text', $params['type'], $params);
    }
    ...
    private function getIconParameters($params) {
        ...
        if(empty($params['custom_icon'])) {
            ...
            if(!empty($params['custom_icon_size'])) {
                $params_array['custom_size'] = coney_qodef_filter_px($params['custom_icon_size']).'px';
            }
	        ...
	        if(!empty($params['shape_size'])) {
		        $params_array['shape_size'] = coney_qodef_filter_px($params['shape_size']).'px';
	        }
            ...
            if($params['icon_border_width'] !== '') {
                $params_array['border_width'] = coney_qodef_filter_px($params['icon_border_width']).'px';
            }
	...
	private function getContentStyles($params) {
		...
		if($params['text_padding'] !== '' && $params['type'] === 'icon-left') {
			$styles[] = 'padding-left: '.coney_qodef_filter_px($params['text_padding']).'px';
		}
		
		if($params['text_padding'] !== '' && $params['type'] === 'icon-top') {
			$styles[] = 'padding-top: '.coney_qodef_filter_px($params['text_padding']).'px';
		}
    ...
    private function getTextStyles($params) {
	    ...
	    if(!empty($params['text_top_margin'])) {
		    $styles[] = 'margin-top: '.coney_qodef_filter_px($params['text_top_margin']).'px';
	    }
