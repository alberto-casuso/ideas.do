<?php
if ( ! function_exists( 'coney_qodef_init_google_fonts_array' ) ) {
    function coney_qodef_init_google_fonts_array() {

        global $coney_qodef_fonts_array;
        $coney_qodef_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'coney_qodef_init_google_fonts_array');
}