...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $coney_qodef_Framework, $coney_qodef_options;
        ...
        if(qodef_core_theme_installed()) {
            $menuPosition = $coney_qodef_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $coney_qodef_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($coney_qodef_options['portfolio_single_slug'])) {
                if($coney_qodef_options['portfolio_single_slug'] != ""){
                    $slug = $coney_qodef_options['portfolio_single_slug'];
                }
            }
        }
